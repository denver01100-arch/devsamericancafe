        ...
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-6">
          ...
          <motion.div className="lg:col-span-6 lg:pt-6" style={{ y: typeY }}>
            <Line play={play} delay={START}>
              <span className="t-eyebrow">Golf Links Market · Mohali</span>
            </Line>
            ...
            >
              ...
              cooks in front of you — original recipes, hand-ground patties and a jar
              of cowboy candy under nearly everything.
            </motion.p>
