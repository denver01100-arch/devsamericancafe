...
export const site = {
  ...
  description:
    "Dev's American Cafe in Mohali — original burgers, sandwiches and American classics built on the pass by Chef Devinder S. Mahal. Golf Link Market, Sector 118, TDI City.",
  url: siteUrl,
  locality: "Sahibzada Ajit Singh Nagar",
  region: "Punjab",
  country: "IN",
  postalCode: "160055",
  street: "Ground Floor, Golf Link Market, SCO 1249, Corner Showroom, Sector 118, TDI City",
  addressLines: [
    "Ground Floor, Golf Link Market",
